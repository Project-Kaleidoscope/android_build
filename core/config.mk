...
ifneq ($(KSCOPE_BUILD),)
include vendor/kscope/target/board/BoardConfigKScope.mk
endif
...
ifneq ($(KSCOPE_BUILD),)
ifneq ($(wildcard device/kscope/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/kscope/sepolicy/common/sepolicy.mk)
endif
endif
